...
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR",
                   ...
                   menu_items={'About': """# This OCR app is created by R.AJITH KUMAR!"""})
...
selected = option_menu(None, ["Home","Upload & Extract","Modify"], 
                       ...
                       styles={"nav-link": {"font-size": "25px", "text-align": "centre", "margin": "0px", "--hover-color": "#ffffcc"},
                               "icon": {"color": "red","font-size": "25px"},
                               "container" : {"max-width": "6000px"},
                               "nav-link-selected": {"background-color": "#31a354"}})
...
if selected == "Home":
    ...
    with col1:
        ...
        github_link = "https://github.com/AjithAnalytics/BizCard_Extracting_Business_Card_Data_with_OCR"
        st.markdown("#     ")
        st.markdown(f"👉 GitHub: [{github_link}]({github_link})")
    with col2:
        image= Image.open(r'C:\pythan\DATA SCEINCE\BizcardX\download.jpg')
        st.image(image)

        st.markdown("#     ")
        st.markdown("#     ")
        st.markdown("## :green[**Upload bisiness card**]")
        image1 = Image.open(r'C:\pythan\DATA SCEINCE\BizcardX\uploaded_cards\4.png')
        st.image(image1)

        st.markdown("## :green[**Data extracted bisiness card**]")
        image2 = Image.open(r'C:\pythan\DATA SCEINCE\BizcardX\Screenshot 2023-11-22 160032.png')
        st.image(image2)
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            ...
            filename = f"uploaded_card_{timestamp}.png"
            file_path = os.path.join("uploaded_cards", filename)
